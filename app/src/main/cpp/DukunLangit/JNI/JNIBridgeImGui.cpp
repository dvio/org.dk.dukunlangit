...
PRIVATE_METHOD static ImGuiKey ImGui_ImplAndroid_KeyCodeToImGuiKey(int32_t key_code)
{
switch (key_code)
{
...
PRIVATE_METHOD void initContext() {
...
PRIVATE_METHOD void renderloop()
{
    ImGuiIO &io = ImGui::GetIO();
    while (run) {
...
PRIVATE_METHOD void init_sfc(JNIEnv *env, jobject surface) {
...
PRIVATE_METHOD static const char* androidbk_get_clipboard(void* user_data) {
    CHECK_ENV
...
PRIVATE_METHOD static void androidbk_set_clipboard(void* user_data, const char* text) {
    CHECK_ENV
...
PRIVATE_METHOD static void loadFonts(ImGuiIO& io, jfloat fontsize, AAssetManager *mgr, bool loadFontDroidSans) {
...
Java_org_dkproject_dukunlangit_ImGui_init(JNIEnv *env, jclass clazz, jobject surface, jfloat fontsize, jfloat scale, jobject assetManager, jboolean enable_droid_sans) {
    initContext();
...
extern "C"
JNIEXPORT void JNICALL
Java_org_dkproject_dukunlangit_ImGui_shutdown(JNIEnv *env, jclass clazz) {
    run = false;
}
extern "C"
JNIEXPORT void JNICALL
Java_org_dkproject_dukunlangit_ImGui_submitPositionEvent(JNIEnv *env, jclass clazz, jfloat x, jfloat y) {
    ImGuiIO &io = ImGui::GetIO();
    io.MousePos = ImVec2(x,y);
}
extern "C"
JNIEXPORT void JNICALL
Java_org_dkproject_dukunlangit_ImGui_submitButtonEvent(JNIEnv *env, jclass clazz, jint btn,
                                                       jboolean pressed) {
    ImGuiIO &io = ImGui::GetIO();
...
Java_org_dkproject_dukunlangit_ImGui_wantsKeyboard(JNIEnv *env, jclass clazz) {
    ImGui::UpdateHoveredWindowAndCaptureFlags();
    return ImGui::GetIO().WantTextInput;
}
extern "C"
JNIEXPORT void JNICALL
Java_org_dkproject_dukunlangit_ImGui_submitUnicodeEvent(JNIEnv *env, jclass clazz,
                                                        jchar codepoint) {
    ImGui::GetIO().AddInputCharacter(codepoint);
}
extern "C"
JNIEXPORT void JNICALL
Java_org_dkproject_dukunlangit_ImGui_submitKeyEvent(JNIEnv *env, jclass clazz, jint key,
                                                    jboolean down) {
    ImGui::GetIO().AddKeyEvent(ImGui_ImplAndroid_KeyCodeToImGuiKey(key), down);
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_org_dkproject_dukunlangit_ImGui_wantsMouse(JNIEnv *env, jclass clazz) {
    ImGuiIO &io = ImGui::GetIO();
    return io.WantCaptureMouse;
}
extern "C"
JNIEXPORT void JNICALL
Java_org_dkproject_dukunlangit_ImGui_resurface(JNIEnv *env, jclass clazz, jobject surface) {
    init_sfc(env, surface);
    eglMakeCurrent(g_EglDisplay, g_EglSurface, g_EglSurface, g_EglContext);
    run = true;
    renderloop();
